                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Visibility(
                                          ...
                                          child: Column(
                                            children: [
                                              Text('오늘의 그냥해 공유하기', textAlign: TextAlign.center, style: TextStyle(fontFamily: "PreRg", fontSize: 25, color: Colors.black,),),
                                              SizedBox(height:20),
                                            ...
                                            Row( mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                                              ...
                                              Text('$HowMany', textAlign: TextAlign.center, style: TextStyle(fontFamily: "PreRg", fontSize: 15, color: Colors.black,),),
